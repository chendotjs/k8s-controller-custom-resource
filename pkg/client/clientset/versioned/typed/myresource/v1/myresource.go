...
import (
	...
	scheme "github.com/chendotjs/k8s-controller-custom-resource/pkg/client/clientset/versioned/scheme"
...
func newMyResources(c *ChendotjsV1Client, namespace string) *myResources {
	return &myResources{
		client: c.RESTClient(),
		ns:     namespace,
	}
